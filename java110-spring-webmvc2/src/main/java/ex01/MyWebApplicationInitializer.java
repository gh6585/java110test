...
public class MyWebApplicationInitializer 
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        //         이렇게 하도록 Servlet 기술 명세에 정의되 있다.
        //
        // 4) SerlvetContainerInitializer 를 실행하는 과정
        //    => spring-web-xxx.jar 파일에 해당 구현체가 있다.
        //    => org.springframework.webSpringServletContainerInitializer 이다.
        //    => 서블릿 컨테이너는 웹 애플리케이션을 시작할 떄
        //       이 클래스에 대해 다음 메서드를 호출한다.
        //
        //       onStartup(Set<Class<?>> c, ServletContext ctx)
        //
        //    => 이 메서드의 첫 번째 파라미터롤 받는 것은
        //       SpringServletContainerInitializer 클래스 위에 선언한
        //       @HandlesTypes 애노테이션에 지정된
        //       WebApplicationInitializer를 구현한 클래스를 모두 찾아
        //       그 클래스 정보를 목록에 담아 준다.
        //    => 그러면 SpringServletContainerInitializer의 onStrat()에서는
        ...
        // => 프론트 컨트롤러 객체를 만들 떄 생성자에 위에서 만든 IoC 컨테이너는 넘긴다.
