...
public class Filter01 implements Filter{
    ...
    public void doFilter(
        ...
        // - 클라이언트가 압출해서 보낸 데이터를 서블릿이 사용할 수 있도록 압축해제 하기
        ...
        // 따라서 빼면 안된다.
        // 최종적으로 서블릿의 service() 호출이끝나면 위 메서든느 리턴된다.
        
        // 서블릿을 실행한 후에 하는 일:
        // - 클라이언트로 보낼 데이터를 압축하기
        // - 클라이언트로 보낼 데이터를 암호화하기
        // - 클라이언트로 보낼 데이터를 특정 형식으로 변환학.
        System.out.println("Filter01.doFilter() -- ater");
    }
...
//   - 플터에 해당하지 않는 RUL이면 이 필터는 동작되지 않는다.
